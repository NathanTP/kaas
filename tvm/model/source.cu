...
#endif
extern "C" __global__ void fused_max_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder_red) {
...
extern "C" __global__ void fused_cast_2_kernel0(int64_t* __restrict__ T_cast, int* __restrict__ placeholder) {
...
extern "C" __global__ void fused_sum_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder_red) {
  float placeholder_red_rf[1];
  float red_buf0[1];
...
extern "C" __global__ void fused_subtract_exp_1_kernel0(float* __restrict__ T_exp, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
