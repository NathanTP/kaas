...
#endif
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2, float* __restrict__ T_relu) {
  float compute[32];
...
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_nn_relu_1_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack) {
  float d[36];
...
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_nn_relu_1_kernel3(float* __restrict__ bgemm, float* __restrict__ placeholder, float* __restrict__ T_relu) {
  float inverse[16];
...
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2, float* __restrict__ T_relu) {
  float compute[16];
...
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2, float* __restrict__ T_add) {
  float compute[6];
...
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ kernel_pack) {
  kernel_pack[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))] = 0.000000e+00f;
  kernel_pack[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))] = (kernel_pack[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))] + placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))]);
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] + (placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 1))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 4096))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] + (placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 1))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] + (placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * -1.066667e+00f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 1))] * -5.333334e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12288))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * -2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] + (placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * 6.666667e-02f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 1))] * -1.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 16384))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * 2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 20480))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 20480))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 20480))] + placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))]);
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] + (placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 3))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 24576))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))] * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * -3.333333e-01f) * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 1))] * -3.333333e-01f) * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * -3.333333e-01f) * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 3))] * 3.333333e-01f) * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 4))] * 3.333333e-01f) * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 5))] * 3.333333e-01f) * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 28672))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) +
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[(((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)))] * 6.666667e-02f) * 6.666667e-02f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 1))] * 6.666667e-02f) * -1.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * 6.666667e-02f) * 2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 3))] * -1.333333e-01f) * 6.666667e-02f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 4))] * -1.333333e-01f) * -1.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 5))] * -1.333333e-01f) * 2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))] * 2.666667e-01f) * 6.666667e-02f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 7))] * 2.666667e-01f) * -1.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 114688))] + ((placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))] * 2.666667e-01f) * 2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 2))] * 6.666667e-02f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 5))] * -1.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 118784))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))] * 2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 122880))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 122880))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 122880))] + placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))]);
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))] * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 7))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 126976))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))] * -3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 7))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 131072))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))] * 3.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))] * -1.066667e+00f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 7))] * -5.333334e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 135168))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))] * -2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 6))] * 6.666667e-02f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 7))] * -1.333333e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 139264))] + (placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))] * 2.666667e-01f));
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 143360))] = 0.000000e+00f;
  kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 143360))] = (kernel_pack[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 143360))] + placeholder[((((((((int)threadIdx.x) & 63) * 576) + (((int)blockIdx.x) * 18)) + ((((int)threadIdx.x) >> 6) * 9)) + 8))]);
}
...
extern "C" __global__ void fused_nn_conv2d_expand_dims_add_nn_relu_1_kernel2(float* __restrict__ kernel_pack, float* __restrict__ data_pack, float* __restrict__ bgemm) {
  float bgemm_local[64];
  __shared__ float kernel_pack_shared[256];
  ...
  for (int ci_outer = 0; ci_outer < 16; ++ci_outer) {
    __syncthreads();
    kernel_pack_shared[(((((int)threadIdx.y) * 16) + ((int)threadIdx.x)))] = kernel_pack[(((((((int)blockIdx.z) * 4096) + (ci_outer * 256)) + (((int)threadIdx.y) * 16)) + ((int)threadIdx.x)))];
    kernel_pack_shared[((((((int)threadIdx.y) * 16) + ((int)threadIdx.x)) + 64))] = kernel_pack[((((((((int)blockIdx.z) * 4096) + (ci_outer * 256)) + (((int)threadIdx.y) * 16)) + ((int)threadIdx.x)) + 64))];
    kernel_pack_shared[((((((int)threadIdx.y) * 16) + ((int)threadIdx.x)) + 128))] = kernel_pack[((((((((int)blockIdx.z) * 4096) + (ci_outer * 256)) + (((int)threadIdx.y) * 16)) + ((int)threadIdx.x)) + 128))];
    kernel_pack_shared[((((((int)threadIdx.y) * 16) + ((int)threadIdx.x)) + 192))] = kernel_pack[((((((((int)blockIdx.z) * 4096) + (ci_outer * 256)) + (((int)threadIdx.y) * 16)) + ((int)threadIdx.x)) + 192))];
    ...
    for (int ci_inner = 0; ci_inner < 4; ++ci_inner) {
      bgemm_local[(0)] = (bgemm_local[(0)] + (kernel_pack_shared[(((ci_inner * 64) + (((int)threadIdx.y) * 8)))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(32)] = (bgemm_local[(32)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 32))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(8)] = (bgemm_local[(8)] + (kernel_pack_shared[(((ci_inner * 64) + (((int)threadIdx.y) * 8)))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(40)] = (bgemm_local[(40)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 32))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(16)] = (bgemm_local[(16)] + (kernel_pack_shared[(((ci_inner * 64) + (((int)threadIdx.y) * 8)))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(48)] = (bgemm_local[(48)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 32))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(24)] = (bgemm_local[(24)] + (kernel_pack_shared[(((ci_inner * 64) + (((int)threadIdx.y) * 8)))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(56)] = (bgemm_local[(56)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 32))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(1)] = (bgemm_local[(1)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 1))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(33)] = (bgemm_local[(33)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 33))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(9)] = (bgemm_local[(9)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 1))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(41)] = (bgemm_local[(41)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 33))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(17)] = (bgemm_local[(17)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 1))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(49)] = (bgemm_local[(49)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 33))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(25)] = (bgemm_local[(25)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 1))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(57)] = (bgemm_local[(57)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 33))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(2)] = (bgemm_local[(2)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 2))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(34)] = (bgemm_local[(34)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 34))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(10)] = (bgemm_local[(10)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 2))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(42)] = (bgemm_local[(42)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 34))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(18)] = (bgemm_local[(18)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 2))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(50)] = (bgemm_local[(50)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 34))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(26)] = (bgemm_local[(26)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 2))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(58)] = (bgemm_local[(58)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 34))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(3)] = (bgemm_local[(3)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 3))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(35)] = (bgemm_local[(35)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 35))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(11)] = (bgemm_local[(11)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 3))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(43)] = (bgemm_local[(43)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 35))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(19)] = (bgemm_local[(19)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 3))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(51)] = (bgemm_local[(51)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 35))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(27)] = (bgemm_local[(27)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 3))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(59)] = (bgemm_local[(59)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 35))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(4)] = (bgemm_local[(4)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 4))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(36)] = (bgemm_local[(36)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 36))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(12)] = (bgemm_local[(12)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 4))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(44)] = (bgemm_local[(44)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 36))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(20)] = (bgemm_local[(20)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 4))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(52)] = (bgemm_local[(52)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 36))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(28)] = (bgemm_local[(28)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 4))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(60)] = (bgemm_local[(60)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 36))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(5)] = (bgemm_local[(5)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 5))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(37)] = (bgemm_local[(37)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 37))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(13)] = (bgemm_local[(13)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 5))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(45)] = (bgemm_local[(45)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 37))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(21)] = (bgemm_local[(21)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 5))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(53)] = (bgemm_local[(53)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 37))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(29)] = (bgemm_local[(29)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 5))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(61)] = (bgemm_local[(61)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 37))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(6)] = (bgemm_local[(6)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 6))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(38)] = (bgemm_local[(38)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 38))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(14)] = (bgemm_local[(14)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 6))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(46)] = (bgemm_local[(46)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 38))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(22)] = (bgemm_local[(22)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 6))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(54)] = (bgemm_local[(54)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 38))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(30)] = (bgemm_local[(30)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 6))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(62)] = (bgemm_local[(62)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 38))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(7)] = (bgemm_local[(7)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 7))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(39)] = (bgemm_local[(39)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 39))] * data_pack_shared[(((ci_inner * 64) + ((int)threadIdx.x)))]));
      bgemm_local[(15)] = (bgemm_local[(15)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 7))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(47)] = (bgemm_local[(47)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 39))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 16))]));
      bgemm_local[(23)] = (bgemm_local[(23)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 7))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(55)] = (bgemm_local[(55)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 39))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 32))]));
      bgemm_local[(31)] = (bgemm_local[(31)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 7))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
      bgemm_local[(63)] = (bgemm_local[(63)] + (kernel_pack_shared[((((ci_inner * 64) + (((int)threadIdx.y) * 8)) + 39))] * data_pack_shared[((((ci_inner * 64) + ((int)threadIdx.x)) + 48))]));
    }
  }
